            ...
            <div v-for="(item, index) in comData.slice(0, showVideos)" class="filler">
                ...
                <div class="videoLayer">
                    <video :src="extract(comData[index], 'videoPath')" :poster="extract(comData[index], 'videoCover')"
                        webkit-playsinline="" playsinline="" x5-video-player-type="h5" preload="none" class="video"
                        muted></video>
                </div>
                <div></div>
                <div class="someAttr">
...
import { double_click } from '../hooks/use-double_click';
// 组件引入
...
//     setTimeout(() => {
//         doubleOut.value.removeChild(heart);
//     }, 1000);
// }
// 双击爱心 //////////////////////////////////////////////////////////////////
</script>
